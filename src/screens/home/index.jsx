        ...
        <View style={styles.body}>
          ...
          <View style={styles.pagerView}>
            ...
            <View style={styles.cardView}>
              <FlatList data={dataFlat} renderItem={({ item }) => <Card style={styles.card} />} horizontal pagingEnabled snapToAlignment="center" style={{ flex: 1 }}></FlatList>
            </View>
          </View>
        </View>
    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardCenter}>
        ...
        <View style={{ flex: 1, justifyContent: 'center', marginVertical: 12 }}>
          <Text style={styles.cardCenterText}>
            -12.77{'('}20%{')'}
          </Text>
        </View>
      </View>
